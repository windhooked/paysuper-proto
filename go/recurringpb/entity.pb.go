...
type Subscription struct {
	...
	// @inject_tag: json:"id"
	CustomerUuid string   `protobuf:"bytes,3,opt,name=customer_uuid,json=customerUuid,proto3" json:"id"`
	...
	ExpireAt              *timestamp.Timestamp `protobuf:"bytes,14,opt,name=expire_at,json=expireAt,proto3" json:"expire_at,omitempty"`
...
var file_entity_proto_rawDesc = []byte{
	...
	0x04, 0x79, 0x65, 0x61, 0x72, 0x22, 0xcd, 0x04, 0x0a, 0x0c, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x3b, 0x72, 0x65, 0x63, 0x75, 0x72,
...
var file_entity_proto_depIdxs = []int32{
	...
	3, // 1: entity.SavedCard.created_at:type_name -> google.protobuf.Timestamp
	3, // 2: entity.SavedCard.updated_at:type_name -> google.protobuf.Timestamp
	3, // 3: entity.Subscription.expire_at:type_name -> google.protobuf.Timestamp
	3, // 4: entity.Subscription.created_at:type_name -> google.protobuf.Timestamp
	3, // 5: entity.Subscription.updated_at:type_name -> google.protobuf.Timestamp
