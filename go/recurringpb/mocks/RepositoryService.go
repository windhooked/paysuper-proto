...
func (_m *RepositoryService) GetMerchantSubscriptions(ctx context.Context, in *recurringpb.GetMerchantSubscriptionsRequest, opts ...client.CallOption) (*recurringpb.GetMerchantSubscriptionsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *recurringpb.GetMerchantSubscriptionsResponse
	if rf, ok := ret.Get(0).(func(context.Context, *recurringpb.GetMerchantSubscriptionsRequest, ...client.CallOption) *recurringpb.GetMerchantSubscriptionsResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*recurringpb.GetMerchantSubscriptionsResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *recurringpb.GetMerchantSubscriptionsRequest, ...client.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
