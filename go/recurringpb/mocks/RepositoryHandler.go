...
func (_m *RepositoryHandler) GetMerchantSubscriptions(_a0 context.Context, _a1 *recurringpb.GetMerchantSubscriptionsRequest, _a2 *recurringpb.GetMerchantSubscriptionsResponse) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *recurringpb.GetMerchantSubscriptionsRequest, *recurringpb.GetMerchantSubscriptionsResponse) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
