...
// GetPlatformsOs provides a mock function with given fields: _a0, _a1, _a2
func (_m *BillingServiceHandler) GetPlatformsOs(_a0 context.Context, _a1 *billingpb.EmptyRequest, _a2 *billingpb.ListPlatformsOsResponse) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *billingpb.EmptyRequest, *billingpb.ListPlatformsOsResponse) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
