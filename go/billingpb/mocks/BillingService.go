...
// FindOrder provides a mock function with given fields: ctx, in, opts
func (_m *BillingService) FindOrder(ctx context.Context, in *billingpb.FindOrderRequest, opts ...client.CallOption) (*billingpb.FindOrderResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *billingpb.FindOrderResponse
	if rf, ok := ret.Get(0).(func(context.Context, *billingpb.FindOrderRequest, ...client.CallOption) *billingpb.FindOrderResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billingpb.FindOrderResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *billingpb.FindOrderRequest, ...client.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
