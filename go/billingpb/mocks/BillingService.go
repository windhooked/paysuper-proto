...
func (_m *BillingService) RoyaltyReportFinanceDone(ctx context.Context, in *billingpb.RoyaltyReportFinanceDoneRequest, opts ...client.CallOption) (*billingpb.EmptyResponseWithStatus, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *billingpb.EmptyResponseWithStatus
	if rf, ok := ret.Get(0).(func(context.Context, *billingpb.RoyaltyReportFinanceDoneRequest, ...client.CallOption) *billingpb.EmptyResponseWithStatus); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billingpb.EmptyResponseWithStatus)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *billingpb.RoyaltyReportFinanceDoneRequest, ...client.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
