...
type OrderCreateRequest struct {
	...
	ButtonCaption string `protobuf:"bytes,41,opt,name=button_caption,json=buttonCaption,proto3" json:"button_caption,omitempty"`
	...
	TestingCase string `protobuf:"bytes,42,opt,name=testing_case,json=testingCase,proto3" json:"testing_case,omitempty"`
	...
	FormMode             string   `protobuf:"bytes,43,opt,name=form_mode,json=formMode,proto3" json:"form_mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type ProjectRedirectSettings struct {
	...
	//
	//The redirect button messages after the successful or failed payment. If it has an empty value the redirect message will be set at OK.
	ButtonCaption        string   `protobuf:"bytes,4,opt,name=button_caption,json=buttonCaption,proto3" json:"button_caption,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Project struct {
	...
	RedirectSettings *ProjectRedirectSettings `protobuf:"bytes,37,opt,name=redirect_settings,json=redirectSettings,proto3" json:"redirect_settings,omitempty"`
	//@inject_tag: json:"webhook_testing"
	//
	// The object contains webhooks' tests results of various test cases.
	WebhookTesting *WebHookTesting `protobuf:"bytes,38,opt,name=webhook_testing,json=webhookTesting,proto3" json:"webhook_testing,omitempty"`
	...
	WebhookMode          string   `protobuf:"bytes,39,opt,name=webhook_mode,json=webhookMode,proto3" json:"webhook_mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type WebHookTesting struct {
	...
	Products *ProductsTesting `protobuf:"bytes,1,opt,name=products,proto3" json:"products,omitempty"`
	//@inject_tag: json:"virtual_currency" bson:"virtual_currency"
	//
	// The webhooks' testing results for the virtual currency.
	VirtualCurrency *VirtualCurrencyTesting `protobuf:"bytes,2,opt,name=virtual_currency,json=virtualCurrency,proto3" json:"virtual_currency,omitempty"`
	//@inject_tag: json:"keys" bson:"keys"
	//
	// The webhooks' testing results for the key.
	Keys                 *KeysTesting `protobuf:"bytes,3,opt,name=keys,proto3" json:"keys,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
type ProjectOrder struct {
	...
	//
	//The customer's redirection settings for the successful or failed payment.
	RedirectSettings     *ProjectRedirectSettings `protobuf:"bytes,18,opt,name=redirect_settings,json=redirectSettings,proto3" json:"redirect_settings,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
type MerchantBanking struct {
	...
	ProcessingDefaultCurrency string   `protobuf:"bytes,8,opt,name=processing_default_currency,json=processingDefaultCurrency,proto3" json:"processing_default_currency,omitempty"`
	XXX_NoUnkeyedLiteral      struct{} `json:"-"`
	XXX_unrecognized          []byte   `json:"-"`
	XXX_sizecache             int32    `json:"-"`
}
...
func (m *MerchantBanking) GetProcessingDefaultCurrency() string {
	if m != nil {
		return m.ProcessingDefaultCurrency
	}
	return ""
}
...
type MerchantTariff struct {
	...
	Chargeback []*MerchantTariffRatesSettingsItem `protobuf:"bytes,4,rep,name=chargeback,proto3" json:"chargeback,omitempty"`
	// @inject_tag: json:"-" bson:"refund"
	Refund []*MerchantTariffRatesSettingsItem `protobuf:"bytes,5,rep,name=refund,proto3" json:"refund,omitempty"`
	//@inject_tag: json:"minimal_payout" bson:"minimal_payout"
	//
	// The merchant's minimal payout amounts.
	MinimalPayout        map[string]float32 `protobuf:"bytes,6,rep,name=minimal_payout,json=minimalPayout,proto3" json:"minimal_payout,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *MerchantTariff) GetChargeback() []*MerchantTariffRatesSettingsItem {
	if m != nil {
		return m.Chargeback
	}
	return nil
...
func (m *MerchantTariff) GetRefund() []*MerchantTariffRatesSettingsItem {
	if m != nil {
		return m.Refund
	}
	return nil
...
func (m *MerchantTariff) GetMinimalPayout() map[string]float32 {
	if m != nil {
...
type Order struct {
	...
	//
	// The webhook testing mode. Available values: correct_payment, non_existing_user, existing_user, invalid_signature.
	TestingCase string `protobuf:"bytes,88,opt,name=testing_case,json=testingCase,proto3" json:"testing_case,omitempty"`
	//@inject_tag: json:"form_mode"
	//
	//The opening mode of the payment form on the project side. Available values: embed, iframe, standalone. Default value: embed.
	FormMode             string   `protobuf:"bytes,89,opt,name=form_mode,json=formMode,proto3" json:"form_mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type TokenSettings struct {
	...
	//
	//The redirect button messages after the successful or failed payment. If it has an empty value the redirect message will be set at OK.
	ButtonCaption        string   `protobuf:"bytes,14,opt,name=button_caption,json=buttonCaption,proto3" json:"button_caption,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type OrderViewPrivate struct {
	...
	OrderChargeBeforeVat *OrderViewMoney `protobuf:"bytes,88,opt,name=order_charge_before_vat,json=orderChargeBeforeVat,proto3" json:"order_charge_before_vat,omitempty"`
...
func init() {
	...
	proto.RegisterMapType((map[string]float32)(nil), "billing.MerchantTariff.MinimalPayoutEntry")
...
var fileDescriptor_958db8ba491a6b57 = []byte{
	// 13394 bytes of a gzipped FileDescriptorProto
	,
}
