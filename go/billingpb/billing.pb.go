...
type OrderReceipt struct {
	...
	IsRecurring string `protobuf:"bytes,20,opt,name=is_recurring,json=isRecurring,proto3" json:"is_recurring"`
	...
	RecurringInterval string `protobuf:"bytes,22,opt,name=recurring_interval,json=recurringInterval,proto3" json:"recurring_interval"`
	...
	ExistsRecurringSubscriptions string `protobuf:"bytes,24,opt,name=exists_recurring_subscriptions,json=existsRecurringSubscriptions,proto3" json:"exists_recurring_subscriptions"`
}
...
func (x *OrderReceipt) GetIsRecurring() string {
	if x != nil {
...
func (x *OrderReceipt) GetExistsRecurringSubscriptions() string {
	if x != nil {
...
var file_billing_proto_rawDesc = []byte{
	...
	0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x73, 0x52, 0x65, 0x63, 0x75, 0x72, 0x72, 0x69,
	...
	0x76, 0x61, 0x6c, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x63, 0x75, 0x72,
	...
	0x28, 0x09, 0x52, 0x1c, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x52, 0x65, 0x63, 0x75, 0x72, 0x72,
