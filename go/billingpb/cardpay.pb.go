...
var file_cardpay_proto_rawDesc = []byte{
	...
	0x07, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x22, 0x94, 0x01, 0x0a, 0x0e, 0x43, 0x61, 0x72,
	...
	0x74, 0x65, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x62, 0x69, 0x6c,
	0x6c, 0x69, 0x6e, 0x67, 0x2e, 0x43, 0x61, 0x72, 0x64, 0x50, 0x61, 0x79, 0x49, 0x74, 0x65, 0x6d,
	...
	0x0b, 0x32, 0x17, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x2e, 0x43, 0x61, 0x72, 0x64,
	...
	0x6e, 0x67, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x62, 0x69, 0x6c, 0x6c, 0x69,
	0x6e, 0x67, 0x2e, 0x43, 0x61, 0x72, 0x64, 0x50, 0x61, 0x79, 0x43, 0x61, 0x6c, 0x6c, 0x62, 0x61,
...
var file_cardpay_proto_goTypes = []interface{}{
	(*CardPayAddress)(nil),                       // 0: billing.CardPayAddress
	(*CardPayItem)(nil),                          // 1: billing.CardPayItem
	(*CardPayMerchantOrder)(nil),                 // 2: billing.CardPayMerchantOrder
	(*CallbackCardPayBankCardAccount)(nil),       // 3: billing.CallbackCardPayBankCardAccount
	(*CallbackCardPayCryptoCurrencyAccount)(nil), // 4: billing.CallbackCardPayCryptoCurrencyAccount
	(*CardPayCustomer)(nil),                      // 5: billing.CardPayCustomer
	(*CardPayEWalletAccount)(nil),                // 6: billing.CardPayEWalletAccount
	(*CallbackCardPayPaymentData)(nil),           // 7: billing.CallbackCardPayPaymentData
	(*CardPayCallbackRecurringDataFilling)(nil),  // 8: billing.CardPayCallbackRecurringDataFilling
	(*CardPayCallbackRecurringData)(nil),         // 9: billing.CardPayCallbackRecurringData
	(*CardPayPaymentCallback)(nil),               // 10: billing.CardPayPaymentCallback
	(*CardPayRefundCallbackRefundData)(nil),      // 11: billing.CardPayRefundCallbackRefundData
	(*CardPayRefundCallbackPaymentData)(nil),     // 12: billing.CardPayRefundCallbackPaymentData
	(*CardPayRefundCallback)(nil),                // 13: billing.CardPayRefundCallback
}
var file_cardpay_proto_depIdxs = []int32{
	1,  // 0: billing.CardPayMerchantOrder.items:type_name -> billing.CardPayItem
	0,  // 1: billing.CardPayMerchantOrder.shipping_address:type_name -> billing.CardPayAddress
	8,  // 2: billing.CardPayCallbackRecurringData.filing:type_name -> billing.CardPayCallbackRecurringDataFilling
	2,  // 3: billing.CardPayPaymentCallback.merchant_order:type_name -> billing.CardPayMerchantOrder
	3,  // 4: billing.CardPayPaymentCallback.card_account:type_name -> billing.CallbackCardPayBankCardAccount
	4,  // 5: billing.CardPayPaymentCallback.cryptocurrency_account:type_name -> billing.CallbackCardPayCryptoCurrencyAccount
	5,  // 6: billing.CardPayPaymentCallback.customer:type_name -> billing.CardPayCustomer
	6,  // 7: billing.CardPayPaymentCallback.ewallet_account:type_name -> billing.CardPayEWalletAccount
	7,  // 8: billing.CardPayPaymentCallback.payment_data:type_name -> billing.CallbackCardPayPaymentData
	9,  // 9: billing.CardPayPaymentCallback.recurring_data:type_name -> billing.CardPayCallbackRecurringData
	2,  // 10: billing.CardPayRefundCallback.merchant_order:type_name -> billing.CardPayMerchantOrder
	12, // 11: billing.CardPayRefundCallback.payment_data:type_name -> billing.CardPayRefundCallbackPaymentData
	11, // 12: billing.CardPayRefundCallback.refund_data:type_name -> billing.CardPayRefundCallbackRefundData
	3,  // 13: billing.CardPayRefundCallback.card_account:type_name -> billing.CallbackCardPayBankCardAccount
	5,  // 14: billing.CardPayRefundCallback.customer:type_name -> billing.CardPayCustomer
	6,  // 15: billing.CardPayRefundCallback.ewallet_account:type_name -> billing.CardPayEWalletAccount
