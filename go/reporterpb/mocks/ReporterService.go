...
import reporterpb "github.com/paysuper/paysuper-proto/go/reporterpb"
...
// CreateFile provides a mock function with given fields: ctx, req, opts
func (_m *ReporterService) CreateFile(ctx context.Context, req *reporterpb.ReportFile, opts ...client.CallOption) (*reporterpb.CreateFileResponse, error) {
